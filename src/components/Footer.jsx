...
const Footer= () =>  {
  ...
  return (
    <footer className="anta-regular px-8 py-10 rounded-t-2xl text-white">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
        <div className="text-center lg:text-left space-y-2">
          <h3 className="text-xl font-semibold">axeiro</h3>
          ...
          <p className="text-xs mt-4">© 2025 axeiro. All rights reserved.</p>
        </div>
